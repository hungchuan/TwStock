...
for i in range(0,array_row):#array_row
    ...
    try:
        ...
        print('download=',year_from_new,month_from_new,month_from_new,Stock_list[i][0])
    ...
    if (sel=='2' or sel=='3'):
        ...
        if (len(df_Good_Stock2)==1):
            ...
            Good_Stock_wks.update_values(crange='A2:I290', values=df_new2_2_list) # update a range of values with a cell list or matrix        
